...
//if (($userlog!="admin") || ($passlog!="admin")) {echo " Access Denied!";};
?>
<?php
...
define("ADMIN_MODE_NEEDS_LOGIN"			, false);
...
define("ADMIN_MODE_VIRTUAL_ROOT"		, "CUSTOM_ROOT");

// added in 2.0;
// An absolute path or null(a string or null)
define("ADMIN_MODE_CUSTOM_VIRTUAL_ROOT"	, "/www/dankort_lab/protocols");
...
define("META_WEB_SITE_NAME"				, "Dankort Lab");
...
class Browser {
	...
	function getHtml() {
		$userlog=$_POST['user'];
		$passlog=$_POST['pass'];
		if ($userlog!="dankortlab") {header("Location: http://dankort-lab.mcgill.ca/testing/protocols.html");}
		else if ($passlog!="ddankort") {header("Location: http://dankort-lab.mcgill.ca/testing/protocols.html");}
...
Sdl.Browser.prototype = {
	...
	onLoad : function() {
		var headers, len;
		document.title = 'Dankort Lab Protocols - Directory Listing';
...
class SimpleDirectoryListing {
	...
	function printHtml() {
		...
		$layout->view = $view;
		$layout->title = Text::htmlentitiesUtf8("Dankort Lab Protocols") . " - Directory Listing";
...
<html>
	<head>
		<title>Dankort Lab - Directory Listing</title>
...
#msg {font-size:0.7em}
	...
	<body>
		<div id='container'>
			...
			<form action='?system=login' method='post' onsubmit='Sdl.login.submit(); return false;' id='login'>
...
//------------------------------------------------------------------------------
define("MODULECHANGEMODE_ON"			, false);
...
//------------------------------------------------------------------------------
define("MODULECREATEFILE_ON"			, false);
...
//------------------------------------------------------------------------------
define("MODULEDOWNLOAD_ON"				, false);
...
//------------------------------------------------------------------------------
define("MODULEFILEMODE_ON"				, false);
...
class ModuleNavigator extends Module {
	...
	function getHtml($cwdRelPath, $view) {
		$cwdRelPath = 'Dankort Lab Protocols';
		$html =
			"
